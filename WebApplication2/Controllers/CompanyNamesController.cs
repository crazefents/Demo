...
namespace WebApplication2.Controllers
{
    public class CompanyNamesController : Controller
    {
        ...
        // GET: CompanyNames
        public ActionResult Index2(string CountryID, string BusinessSectorID, string CompanyName1, string fields, string CompanyTypeID, string ExchangeCode, string searchString, string ExchangeCodeName)
        {
